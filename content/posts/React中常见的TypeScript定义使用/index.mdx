...
在我学习`typescript`时，想在`react`中使用`typescript`写代码，从头开始的时候是懵逼的，因为官方文档并没有使用`typescript`的教程，多是自己在网上查，自己看定义摸索
...
`ts`自带了一些工具泛型，比如`Omit`、`Pick，`在开发的时候还是有帮助，可以看看我以前的[总结](https://zhangyu1818.com/blog/Typescript工具泛型/)
